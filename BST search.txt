...
void displayMenu() {
    ...
    cout << "2. Mirror the tree (swap left/right pointers)" << endl;
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: 
                if (root == nullptr) {
                    cout << "Tree is empty, nothing to mirror." << endl;
                } else {
                    mirrorTree(root);
                    cout << "Tree has been mirrored (left and right pointers swapped)." << endl;
                }
                break;
            case 3: 
